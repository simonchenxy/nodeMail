...
module.exports = function (user, password, host) {
    var imap = new Imap({
        user: user, //你的邮箱账号
    ...
    imap.once('ready', function () {
        ...
        openInbox(function (err, box) {
            ...
            imap.search(['ALL', ['SINCE', 'June 5, 2018']], function (err, results) {//搜寻2017-05-20以后未读的邮件
                    ...
                    msg.on('body', function (stream, info) {
                        ...
                        mailparser.on("headers", function (headers) {
                            ...
                            MongoClient.connect(url, (err, db) => {
                                ...
                                dbase.collection('data').insertOne(myObj, (err, res) => {
                                    if (err) throw err;
                                    console.log("文档插入成功");
                                    db.close();
                                })
